-- SQL para desabilitar RLS ou permitir acesso public (anon key)
-- Execute isto no Supabase Dashboard: SQL Editor

-- Opção 1: Desabilitar RLS completamente (menos seguro, mas permite testes)
ALTER TABLE drivers DISABLE ROW LEVEL SECURITY;
ALTER TABLE trips DISABLE ROW LEVEL SECURITY;
ALTER TABLE incidents DISABLE ROW LEVEL SECURITY;

-- Opção 2 (RECOMENDADO): Permitir SELECT, INSERT, UPDATE, DELETE para usuários anon
